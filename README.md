...
1. Clone Vorocrust-Meshing
    ...
    $ git clone git@gitlab.sandia.gov:vorocrust/vorocrust-meshing.git
    ```
...
|--------------------------------------|:-------------:|:--------:|------------------------------------------------------------------------------|
| `VOROCRUST_BUILD_AI`                 |      ON       |    NO    | Include `src/AI` codes                                                       |
| `VOROCRUST_BUILD_DATACOMPRESSION`    |      ON       |    NO    | Include `src/DataCompression` codes                                          |
| `VOROCRUST_BUILD_EXPERIMENTAL`       |      ON       |    NO    | Include `src/Experimental` codes                                             |
